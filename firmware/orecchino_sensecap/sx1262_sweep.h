...
// read instantaneous RSSI, plus one-time init). Handles the Indicator's
// quirks: control lines on the IO expander, DIO2 as RF switch, optional
// TCXO on DIO3 (V2 boards; falls back to crystal on XOSC start error).
#pragma once
#include <Arduino.h>
